...
SquareLine note:
If you use screens with opacity/alpha of 0 you might face screen refresh issues with this board template's windows driver.
In the new lv_port_pc_visual_studio (and the new 2.0.0 board-template) this seems corrected.
(Later the lv_port_pc_visual_studio 8.3 branch or we might improve the windows-API display driver of LVGL for this board-template too.)
