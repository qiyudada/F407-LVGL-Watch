...
void ui_HomePage_screen_init(void)
{
    ...
    sprintf(home_value_strbuf, "%02d:%02d", (char)ui_TimeHourValue, (char)ui_TimeMinuteValue);
    lv_label_set_text(ui_ClockNumberLabel, home_value_strbuf);
    ...
    sprintf(home_value_strbuf, "%s %02d", ui_Days[ui_DataWeekdayValue - 1], (char)ui_DateDayValue);
    lv_label_set_text(ui_DateLabel, home_value_strbuf);
