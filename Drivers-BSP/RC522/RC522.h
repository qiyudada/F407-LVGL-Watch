...
/*if No create pin define in stm32cubemx*/
#if 0
...
#define RC522_NSS(N) HAL_GPIO_WritePin(RC522_SDA_GPIO_Port, RC522_SDA_Pin, N == 1 ? GPIO_PIN_SET : GPIO_PIN_RESET)

/*if you want to interrupt rc522 randomly*/
#if 0
