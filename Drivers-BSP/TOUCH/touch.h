...
#define T_CS_GPIO_PIN GPIO_PIN_0
...
#define T_MOSI_GPIO_PIN GPIO_PIN_1
...
#define T_MOSI(x)                                                                                                                                      \
    do                                                                                                                                                 \
    {                                                                                                                                                  \
        x ? HAL_GPIO_WritePin(T_MOSI_GPIO_PORT, T_MOSI_GPIO_PIN, GPIO_PIN_SET) : HAL_GPIO_WritePin(T_MOSI_GPIO_PORT, T_MOSI_GPIO_PIN, GPIO_PIN_RESET); \
    } while (0) /* T_MOSI */

#define T_CLK(x)                                                                                                                                   \
    do                                                                                                                                             \
    {                                                                                                                                              \
        x ? HAL_GPIO_WritePin(T_CLK_GPIO_PORT, T_CLK_GPIO_PIN, GPIO_PIN_SET) : HAL_GPIO_WritePin(T_CLK_GPIO_PORT, T_CLK_GPIO_PIN, GPIO_PIN_RESET); \
    } while (0) /* T_CLK */

#define T_CS(x)                                                                                                                                \
    do                                                                                                                                         \
    {                                                                                                                                          \
        x ? HAL_GPIO_WritePin(T_CS_GPIO_PORT, T_CS_GPIO_PIN, GPIO_PIN_SET) : HAL_GPIO_WritePin(T_CS_GPIO_PORT, T_CS_GPIO_PIN, GPIO_PIN_RESET); \
    } while (0) /* T_CS */
